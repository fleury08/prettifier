...
function test {
    ...
    export DISPLAY=:0
    ./com.github.fleury08.prettifier --run-tests
    result=$?
...
"generate-i18n")
    initialize
    ninja com.github.fleury08.prettifier-pot
    ninja com.github.fleury08.prettifier-update-po
    ;;
"install")
    initialize
    sudo ninja install
...
"run")
    initialize
    ./com.github.fleury08.prettifier "${@:2}"
    ;;
"test")
    test
    ;;
